function [alts,times, vdops, altSTD,medianlla,aveCNO]=gpsToalt(dirName,prFileName)
...
%prFileName = 'gnss_log_2024_11_20_17_16_13.txt'
...
%dirName = 'C:\Users\griff\OneDrive\Documents\matlab\Stanford\AA272\Project\gnsslogger\demoFiles';
...
gpsPvt = GpsWlsPvtOnlyAlts(gnssMeas,allGpsEph);
alts=gpsPvt.allLlaDegDegM(:,3);
times=gpsPvt.FctSeconds;
vdops=gpsPvt.vdop;
altSTD=gpsPvt.sigmaLLaM(:,3);
medianlla=gpsPvt.llaMed;
...
for i=1:M
    ...
    tAVEcno(i)=mean(Cn0iDbHz,"omitnan");

end
aveCNO=mean(tAVEcno,"omitnan");
%% plot Pvt results
% h4 = figure;
